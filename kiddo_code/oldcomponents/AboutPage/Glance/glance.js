                ...
                <section className="dark-blue-bg at-glance-wrap">
                    <div className="container">
                        ...
                        <div className="row justify-content-center col-md-9">
                            ...
                            <div className="col-6 mb-3 col-lg-3 mb-lg-0 aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
                                <span className="display-4 text-primary d-block mb-10" data-countup="" data-start="0" data-end="10" data-duration="3" data-grouping="true" data-suffix="">{this.state.at_a_glance_number_2 ? this.state.at_a_glance_number_2 : ""}</span>
                                <span className="h6">{this.state.at_a_glance_text_2 ? this.state.at_a_glance_text_2 : ""}</span>
                            </div>
                            <div className="col-6 mb-3 col-lg-3 mb-lg-0 aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
                                <span className="display-4 text-primary d-block mb-10" data-countup="" data-start="0" data-end="10" data-duration="3" data-grouping="true" data-suffix="">{this.state.at_a_glance_number_3 ? this.state.at_a_glance_number_3 : ""}</span>
                                <span className="h6">{this.state.at_a_glance_text_3 ? this.state.at_a_glance_text_3 : ""}</span>
                            </div>
                            <div className="col-6 mb-3 col-lg-3 mb-lg-0 aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
                                <span className="display-4 text-primary d-block mb-10" data-countup="" data-start="0" data-end="10" data-duration="3" data-grouping="true" data-suffix="">{this.state.at_a_glance_number_4 ? this.state.at_a_glance_number_4 : ""}</span>
