                    ...
                    <div className="container">
                        <div className="row justify-content-center text-center min-vh-50 align-items-center hero-banner">
                            <div className="col-xl-9 col-lg-9 col-md-10">
                                <a data-fancybox="" href="https://vimeo.com/421689971" className="btn btn-xlg btn-primary btn-round mx-auto mb-4 aos-init aos-animate" data-aos="fade-up">
                                ...
                                <h4 className="display-4 mb-2">Custom Bundle </h4>
                                {/* <p>Front-end skills are in high demand, and plenty of people know HTML and CSS. Set yourself apart by building a foundation in JavaScript. Then, you'll create interactive applications with React—the library that powers Facebook and Netflix.</p> */}
                            </div>
                        </div>
                    </div>
                    <div id="jarallax-container-1" style={{position: 'absolute', top: 0, left: 0, width: 100, height: 100, overflow: 'hidden', pointerEvents: 'none', zIndex: 1}}>
                    
                    </div>
                    <div className="banner-image">
                        <img src="images/bg-img02.jpg" alt="Hero Banner" className="jarallax-img opacity-50" />
                    </div>
                </section>
            </>
        )
