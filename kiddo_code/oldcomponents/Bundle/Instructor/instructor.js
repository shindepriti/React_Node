...
class Instructor extends Component {
    ...
    fetch(process.env.GRAPHURL, {
      ...
      .then((response) => {
        ...
        if (response.data.products) {
          ...
          this.setState({
            product_instructor: productData ? productData.instructor[0] : null
          });
        }
      });
  ...
  render() {
    ...
    console.log('productData', product_instructor)
    return (
      <>
          ...
          <div className="container pt-0" data-aos="fade-up">
            <div className="row align-items-center justify-content-around">
              <div className="col-md-5 mb-2">
                ...
                <img src={product_instructor && product_instructor.team_image ? process.env.GRAPHIMAGEURL + product_instructor.team_image.url : "/assets/images/course-2.png"} alt="Image" className="rounded-circle layer-2 p-3" />
