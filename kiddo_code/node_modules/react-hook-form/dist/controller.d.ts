...
declare const Controller: <TAs extends React.ReactElement<any, string | ((props: any) => React.ReactElement<any, string | any | (new (props: any) => React.Component<any, any, any>)> | null) | (new (props: any) => React.Component<any, any, any>)> | React.ComponentClass<any, any> | React.FunctionComponent<any> | "input" | "select" | "textarea", TControl extends Control<Record<string, any>> = Control<Record<string, any>>>({ name, rules, as, render, defaultValue, control, onFocus, ...rest }: import("./types/utils").Assign<{
    name: import("./types/form").FieldName<import("./types/form").FieldValuesFromControl<TControl>>;
    as?: TAs | undefined;
    rules?: Partial<{
        required: string | boolean | import("./types/form").ValidationValueMessage<boolean>;
        min: import("./types/form").ValidationRule<React.ReactText>;
        max: import("./types/form").ValidationRule<React.ReactText>;
        maxLength: import("./types/form").ValidationRule<React.ReactText>;
        minLength: import("./types/form").ValidationRule<React.ReactText>;
        pattern: import("./types/form").ValidationRule<RegExp>;
        validate: import("./types/form").Validate | Record<string, import("./types/form").Validate>;
    }> | undefined;
