...
class Testimonial extends Component {
    ...
    render(){
        ...
        return (
            <>
              <section className="testimonial-wrap xlight-gray-bg">
                    ...
                    <div className="col-md-7 col-xl-7">
                      <div className="row justify-content-center">
                        <div className="col-xl-10 col-lg-11">
                          ...
                          <div className="mb-2 font-weight-bold position-txt">- <div className="mb-2">{this.state.full_name + ', ' + this.state.founder}</div></div>
                        </div>
                      </div>
                    </div>
                    <div className="col-md-4 col-lg-4 mb-md-0">
                      <div className="video-poster rounded mb-3">
                        <a data-fancybox="" href="https://vimeo.com/421689971" className="btn btn-lg btn-primary btn-round">
                          <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" className="injected-svg icon" data-src="http://54.255.146.92/wp-content/themes/kidocode/assets/img/icons/theme/media/play.svg" data-pagespeed-url-hash="4291238768">
