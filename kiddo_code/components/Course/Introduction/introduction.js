...
class Introduction extends Component {
    ...
    componentDidMount() {
        ...
        .then((response) => {
            console.log("Product Introduction :",response);
            let productData = [];
    ...
    render(){
              const { product_name, product_introduction, product_hours,product_type, product_testimonial, product_sell_price } = this.state;
                      ...
                      <div className="col-md-4">
                        <div className="price-desc align-center text-right">
                          <h2 className="price d-inline-block align-middle mb-0">
                            <strong>RM{product_sell_price ? product_sell_price : ''}
                              <span className="price-tag">
                                <span className="h6 opacity-30 font-weight-normal">RM{product_sell_price ? product_sell_price : ''}</span>
                ...
                <div className="container">
                  <div className="row justify-content-between o-visible">
                    <div className="col-md-6">
                      ...
                      <div className="avatar-author align-items-center mt-4">
                        <img src="/assets/images/image-1.jpg" alt="Avatar" className="avatar avatar-sm"/>
                        <div className="ml-2">
                          <span>Created by</span>
                          <span className="text-darkblue font-weight-bold ml-2">Kidocode</span>
                        </div>
                      </div>
                      <div className="d-block mt-4">
                        <a href="#" className="btn btn-border-wrap border-gray text-dark rounded-0">Save for later </a>
                        <a href="#" className="btn btn-border-wrap border-gray text-dark rounded-0 ml-2">Share</a>
                      </div>
                      
                      <div className="border-top mt-4 frequently-wrap fascinates-section row pt-2">
                        <div className="col-md-8">
